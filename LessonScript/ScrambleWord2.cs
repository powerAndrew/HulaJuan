...
public class ScrambleWord2 : MonoBehaviour
{
    ...
    public CharObject2 prefab;
    public Transform container;
    public int currentWord;
    public string[] words;
    List<CharObject2> charObjects = new List<CharObject2>();
    ...
    public void showScrambleLetters(int index)
    {
        ...
        {
            clone = Instantiate(prefab.gameObject).GetComponent<CharObject2>();
    ...
    public void CoCheckWord()
    {
            ...
            || prefab.inputField.text == "guho" || prefab.inputField.text == "goma" || prefab.inputField.text == "baga")
        {
            ...
            player2.currentState = Player2Script.Turnstate.action;
            Debug.Log("Easy!");
            DoDamage();
        }
        ...
        else if (prefab.inputField.text == "pinagaaral" || prefab.inputField.text == "kumakandili" || prefab.inputField.text == "dalubulnungan" || prefab.inputField.text == "balusuplingan"
